...
const FooterWithSocialLinksComponent = () => {
  return (
    <footer className="relative w-full bg-footerBackGround">
      <div className="mx-auto w-full max-w-screen-2xl px-8 py-8">
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
          ...
          >
            &copy; {currentYear} <a href="https://sk-kaskad72.ru"> Компания "Каскад" - строительная компания.</a> Все права защищены.
          </Typography>
          <div className="flex gap-4 text-white sm:justify-center">
            <Typography as="a" href="#" className="opacity-80 transition-opacity hover:opacity-100 hover:text-green-600">
...
export default FooterWithSocialLinksComponent;